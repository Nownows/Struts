...
<div id="enveloppe">									
	...
	<s:form method="post" action="ValiderInscriptionParticulier">
		<s:textfield name="login" id="login" label="Login" labelposition="top" cssClass="input"/>
                ...
                <s:textfield name="nom" id="nom" label="Nom" labelposition="top" cssClass="input"/>
                <s:textfield name="prenom" id="prenom" label="Prenom" labelposition="top" cssClass="input"/>
